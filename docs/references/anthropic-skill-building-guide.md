...
> **Source & attribution**
>
> - **Source:** Anthropic, *The Complete Guide to Building Skills for Claude* (PDF).
> - **Source URL:** <https://resources.anthropic.com/hubfs/The-Complete-Guide-to-Building-Skill-for-Claude.pdf>
> - **Retrieved:** 2026-06-02
> - **Original format:** PDF, 33 pages, `%PDF-1.4`, 561,652 bytes.
> - **SHA-256 of source PDF:** `66cbcc06df9271e0bb59986582646f0c4c7c94697554f893f937a5a55cef736d`
> - **Conversion:** Transcribed from the PDF to GitHub-Flavored Markdown by hand for in-repo reference. Layout (two-column pages, cover art, chapter dividers) is linearized; wording, code blocks, tables, and examples are preserved verbatim. Page numbers from the source are noted as `_(p. N)_` at section boundaries.
>
> **Licensing / usage caveat:** This is third-party material © Anthropic. It is reproduced here **verbatim for internal reference only**, to inform how this repository authors Claude skills. It is **not** original work of this repository and carries no separate license grant. Do not redistribute outside this context; treat Anthropic's published terms as governing. If Anthropic updates or relocates the source, re-fetch from the canonical URL above rather than relying on this copy.
...
- Provides context would otherwise need to specify
...
Result: Campaign created with provided direct link
...
_End of guide. Source: claude.ai — Anthropic._
